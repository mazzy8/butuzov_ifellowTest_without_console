#language: ru
Функция: Найти список серий заданного персонажа. Получить список всех персонажей последней серии. Получить данные
  последего персонажа из списка. Сравнить данные с данными искомого персонажа
